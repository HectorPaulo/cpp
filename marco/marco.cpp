...
int main(){
	...
	posxy(20, 3);cout<<"Este es un programa que muestra un vector con números del 1-10 de la forma {a, b, c}."<<endl;
	cout<<"-----------------------------------------------------------------------------------------------------------------------"<<endl<<endl;
    ...
    cin >> y;
	posxy(45, 17); cout << "ingrese, a continuacion, los números del 1 al 10: "<<endl<<endl;
    ...
    // Imprimir espacios en blanco para mover el cursor a la posición deseada
    for (int i = 0; i < y; i++) {
        cout << endl;
    }
    for (int i = 0; i < x; i++) {
